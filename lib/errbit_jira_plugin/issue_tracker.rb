  ...
  class IssueTracker < ErrbitPlugin::IssueTracker
    ...
    def create_issue(problem, reported_by = nil)
      begin
        ...
        the_title =  String.new(problem.message.to_s.truncate(100)),
        ...
        issue.save({"fields"=>{"summary"=>the_title, "description"=>issue_description, "project"=>{"id"=>params['project_id']},"issuetype"=>{"id"=>"3"}}})
